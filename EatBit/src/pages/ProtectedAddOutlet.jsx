...
import { FaPlus, FaTrash, FaUtensils, FaMapMarkerAlt, FaClock, FaPhone, FaImage, FaArrowLeft } from "react-icons/fa";

const ProtectedAddOutlet = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const outletToSave = {
                ...
                createdBy: adminInfo?.id || 'admin',
                createdByUsername: adminInfo?.username || 'admin',
                createdAt: serverTimestamp(),
                updatedAt: serverTimestamp()
            };

            // Add to Firestore
            await addDoc(collection(db, "outlets"), outletToSave);
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            {/* Admin Header */}
            <div className="bg-white shadow-lg border-b border-gray-200 py-4">
                <div className="max-w-6xl mx-auto px-4 flex items-center justify-between">
                    <button
                        onClick={() => navigate('/admin-dashboard')}
                        className="flex items-center gap-2 text-gray-600 hover:text-gray-800 font-semibold transition duration-200"
                    >
                        <FaArrowLeft /> Back to Dashboard
                    </button>
                    <div className="flex items-center gap-2 text-gray-600">
                        <span className="font-medium">Admin: {adminInfo.username}</span>
                    </div>
                </div>
            </div>
...
export default ProtectedAddOutlet;